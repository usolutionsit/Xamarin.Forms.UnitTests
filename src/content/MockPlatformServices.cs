...
namespace Xamarin.Forms.Core.UnitTests
{
	internal class MockPlatformServices : IPlatformServices
	{
		...
		Func<Uri, CancellationToken, Task<System.IO.Stream>> getStreamAsync;
		public MockPlatformServices(Action<Action> invokeOnMainThread = null, Action<Uri> openUriAction = null, Func<Uri, CancellationToken, Task<System.IO.Stream>> getStreamAsync = null)
		{
		...
		public Task<System.IO.Stream> GetStreamAsync(Uri uri, CancellationToken cancellationToken)
		{
